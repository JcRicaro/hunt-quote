	...
	<div class="box box-solid">
		...
		<div class="box-body">
			...
			<div class="form-group">
				...
				{{ Form::select('topics[]', $topics, null, ['class' => 'form-control chosen-select', 'multiple' => 'multiple']) }}
			</div>

			<div class="form-group">
				{{ Form::label('tags', 'Tags') }}
				{{ Form::select('tags[]', $tags, null, ['class' => 'form-control chosen-select', 'multiple' => 'multiple']) }}
			</div>

			<div class="form-group">
				{{ Form::label('content', 'Quote') }}
				{{ Form::textarea('content', null, ['class' => 'form-control', 'placeholder' => 'Enter Quote Here']) }}
			</div>
